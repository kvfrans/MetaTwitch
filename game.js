...
socket.on('hasStreamers', function (data)
{
    ...
    for(var i = 0; i < data.streamers.length; i++)
    {
        ...
        $("#stats").html($("#stats").html() + "<div class=\"col-md-3\"><div class=\"panel panel-default\"><div class=\"panel-heading\"><h3 class=\"panel-title\">"+ data.streamers[i].name +"</h3></div><div class=\"panel-body\"><div id=\"game" + data.streamers[i].name.toLowerCase() + "\"> Playing: "+ data.streamers[i].game +"</div><div id=\"chats-" + data.streamers[i].name.toLowerCase() + "\">Warming up chats...</div><div id=\"cps-" + data.streamers[i].name.toLowerCase() + "\">Warming up CPS...</div></div></div></div>");
        // }
